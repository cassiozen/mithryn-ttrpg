...
Any die that rolled its maximum number (a 12 for a d12, for example) is always a hit (regardless of the target’s Defense). Plus, it may be rolled again for another chance to score a hit. These extra rolls can also explode.
...
PCs equipped with a shield can react to incoming attacks with the defend action to automatically cancel one hit.
...
Dice may be d10, d12, or d20 — larger dice are more swingy but have a greater chance of rolling equal to or above the target’s Defense score.
